...
class DemandesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create demande" do
    assert_difference('Demande.count') do
      post demandes_url, params: { demande: { end_date: @demande.end_date, groupe_id: @demande.groupe_id, prix: @demande.prix, start_date: @demande.start_date, statut: @demande.statut, user_id: @demande.user_id } }
    end
  ...
  test "should update demande" do
    patch demande_url(@demande), params: { demande: { end_date: @demande.end_date, groupe_id: @demande.groupe_id, prix: @demande.prix, start_date: @demande.start_date, statut: @demande.statut, user_id: @demande.user_id } }
